  ...
  return (
    <div>
      ...
      {!image ? (
        ...
        >
          <div className="w-14 h-14 flex items-center justify-center bg-orange-300 rounded-full border border-black-10">
            <BsUpload className="text-3xl font-bold text-black-500" />
          </div>
